        ...
        try:
            ...
            for cliente in clientes:
                ...
                if(client_count % BATCH_SIZE == 0):
                    print("[ii] Fit of {} clients".format(client_count))
                    model.fit(X, y.values.flatten()) # https://stackoverflow.com/questions/34165731/a-column-vector-y-was-passed-when-a-1d-array-was-expected
                    print("termine!!!!")
